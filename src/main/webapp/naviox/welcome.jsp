...
In eckarmanager-labels_en.properties:
eckarmanager=My application
eckarmanager[description]=My application does this and that

In eckarmanager-messages_en.properties:
